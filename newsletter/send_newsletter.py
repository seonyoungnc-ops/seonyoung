...
# 수집 쿼리 — 카테고리별 독립 키워드, 카테고리 간 겹침 없음
NAVER_QUERIES = {
    # 국내 게임: 특정 회사명 + 장르/이슈 키워드 병행
    "domestic_game": [
        "국내 게임 신작 출시",
        "모바일게임 PC게임 흥행",
        "넥슨 넷마블 크래프톤 신작",
...
2. 동일하거나 유사한 주제·이슈 기사가 여러 개면 가장 중요한 1개만 선택. 중복 금지.
3. summary: 기사 핵심 내용 2~3줄. 절대 비우지 말 것.
4. reason: 플랫폼 기획자가 주목해야 할 이유 1~2줄. 절대 비우지 말 것.
5. title: 그대로 사용 (국문 기사는 원본, 영문이면 한국어 번역).
6. link: 입력된 URL만 사용. 절대 새로 생성 금지.

JSON 배열만 출력 (다른 텍스트 없이):
[
  {{
    "category_id": "{cat_ids} 중 정확히 하나",
    "category_insight": "{cat_labels} 오늘의 핵심 흐름 1~2문장",
    "articles": [
      {{
        "title": "기사 제목",
        "link": "원본 URL",
